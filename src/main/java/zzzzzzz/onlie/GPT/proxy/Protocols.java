...
public class Protocols {
    ...
    public interface First{
        final static byte url ='U';
        final static byte body ='B';
        final static byte method ='M';
        final static byte heard ='H';

        final static byte username ='N';
        final static byte password ='P';
